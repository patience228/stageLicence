...
/**
 * QAffectation is a Querydsl query type for Affectation
 */
@Generated("com.querydsl.codegen.EntitySerializer")
public class QAffectation extends EntityPathBase<Affectation> {

    private static final long serialVersionUID = -926159633L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAffectation affectation = new QAffectation("affectation");
    ...
    public QAffectation(String variable) {
        this(Affectation.class, forVariable(variable), INITS);
    }

    public QAffectation(Path<? extends Affectation> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QAffectation(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QAffectation(PathMetadata metadata, PathInits inits) {
        this(Affectation.class, metadata, inits);
    }

    public QAffectation(Class<? extends Affectation> type, PathMetadata metadata, PathInits inits) {
